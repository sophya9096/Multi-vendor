...
const columns = [
    ...
    { field: "col1", headerName: "Name", width: 300, cellClassName: "Freelancers" },
    { field: "col2", headerName: "Privacy", width: 150, cellClassName: "JobTitle" },
    { field: "col3", headerName: "Action", width: 150, cellClassName: "Assigned" },
...
function YourProposals() {
    ...
    return (
        <div className={""}>
            <h1 style={{ marginBottom: "25px" }}>Company List</h1>
