...
const rows = [
    ...
    },
    {
        id: 3,
        col0: 3,
        col1: "Professional writer required",
        col2: "5 days",
        col3: "$15",
        col4: "1000",
        col5: "879",
...
const columns = [
    ...
    { field: "col1", headerName: "Job Title", width: 250, cellClassName: "title" },
...
function JobPosted() {
    ...
    return (
        <div>
            <h1 style={{ marginBottom: "25px" }}>Your Jobs Featured</h1>
